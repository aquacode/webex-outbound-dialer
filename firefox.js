...
(async () => {
  const browser = await firefox.launch({ headless: false , args: [
          "media.webrtc.hw.h264.enabled=1",
          //"media.getusermedia.screensharing.enabled=1",
          //"media.navigator.permission.disabled=1",
          //"media.peerconnection.video.h264_enabled=1",
